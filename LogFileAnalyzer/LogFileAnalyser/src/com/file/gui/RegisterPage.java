...
public class RegisterPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, 400, 490));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!Validation.isValidEmail(email)){
            ...
            JOptionPane.showMessageDialog(null , "Password must be at least 8 characters long and include an uppercase letter, a lowercase letter, a number, and a special character.");
        }
        else if(!password.equals(confirmPassword)){
            JOptionPane.showMessageDialog(null , "Passwords do not Matched");
        }
        else if(UserRepository.isUsernameOrEmailExists(username , email)){
