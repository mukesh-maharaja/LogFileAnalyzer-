...
public class Explore extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            outputStream.close();
            inputStream.close();
            JOptionPane.showMessageDialog(null , "Download Completed and file stored at path "+savePath);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        JFrame frame = new JFrame("Subscription Comparison");
        frame.setSize(600, 400);

        // Create table data
        String[] columns = {"Feature", "Ordinary", "Premium"};
        Object[][] data = {
                {"Storage Limit", "✓", "✓"},
                {"Search Logs", "✓", "✓"},
                {"Export Reports", "✓", "✓"},
                {"Unlimited Storage", "✗", "✓"},
                {"Unlimited Logging", "✗", "✓"},
                {"Export Reports as any Format", "✗", "✓"},
                {"Multi user Support", "✗", "✓"},
                {"Customization og Logs", "✗", "✓"}
        };
        ...
        table.getTableHeader().setFont(new Font("ALGERIAN", Font.BOLD, 21));
